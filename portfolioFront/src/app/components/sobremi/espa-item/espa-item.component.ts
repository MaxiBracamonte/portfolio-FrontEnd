...
import { ACER } from 'src/app/mock-task';
...
export class EspaItemComponent implements OnInit {
  ...
  @Input() espa: Sobremi = ACER[0];
  @Output() onEliminarEspa: EventEmitter<Sobremi> = new EventEmitter();
  ...
  constructor(
    private acerSer: SobremiService,
